...
const preview=index
  .replace('<link rel="stylesheet" href="styles.css?v=20260810-qr8">',`<style>\n${styles}\n</style>`)
  .replace('<script src="online-config.js?v=20260810-qr8"></script>',`<script>\n${config}\n</script>`)
  .replace('<script src="vendor/qrcode.min.js?v=20260810-qr8"></script>',`<script>\n${safeQrcode}\n</script>`)
  .replace('<script src="vendor/html2canvas.min.js?v=20260810-qr8"></script>',`<script>\n${safeHtml2canvas}\n</script>`)
  .replace('<script type="module" src="app.js?v=20260810-qr8"></script>',`<script type="module">\n${inlineWorkflow}\n${inlineApp}\n</script>`)
